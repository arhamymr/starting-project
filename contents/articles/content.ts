...
<p class="p1"><span class="Apple-converted-space">&nbsp;&nbsp; &nbsp; </span>- Gunakan minyak kelapa atau yogurt rendah lemak sebagai pengganti mentega.&nbsp;</p>
<p class="p1"><span class="Apple-converted-space">&nbsp;&nbsp; </span><strong>Hasil</strong>: Brownies lembut yang aman untuk penderita diabetes.</p>
<p class="p1"><strong>Bahan-bahan: </strong></p>
<ul class="ul1">
<li class="li1">Cokelat hitam tanpa gula (dark chocolate 70-90%): 150 gram (lelehkan).</li>
<li class="li1">Yogurt atau minyak kelapa : 100 gram (lelehkan).</li>
<li class="li1">Pemanis pengganti gula (stevia, erythritol, atau xylitol): 100-120 gram (sesuai selera).</li>
<li class="li1">Telur ayam : 3 butir.</li>
<li class="li1">Ekstrak vanili : 1 sdt.</li>
<li class="li1">Tepung almond atau tepung gandum: 50 gram (atau tepung rendah karbohidrat lainnya).</li>
<li class="li1">Kakao bubuk tanpa gula : 30 gram.</li>
<li class="li1">Bubuk pengembang : 1 sdt.</li>
<li class="li1">Sejumput garam</li>
</ul>
<p class="p2">&nbsp;</p>
<p class="p1"><strong>Cara membuat : </strong></p>
<p class="p1">Lelehkan cokelat : Potong kecil-kecil dark chocolate dan lelehkan bersama minyak kelapa atau yogurt menggunakan metode double boiler (wadah di atas panci berisi air panas) atau microwave. Aduk hingga cokelat benar-benar meleleh dan tercampur rata.</p>
<p class="p1">Kocok telur dan pemanis Dalam wadah terpisah, kocok telur bersama erythritol hingga berbusa dan agak mengembang.</p>
<p class="p1">Campurkan bahan basah Tambahkan cokelat leleh ke dalam campuran telur sambil terus diaduk. Masukkan ekstrak vanila jika digunakan.</p>
<p class="p1">Campurkan bahan kering Ayak tepung almond, bubuk kakao, baking powder, dan garam.</p>
<p class="p1"><strong>Nilai Gizi</strong></p>
<p class="p1">Perkiraan Nilai Gizi (50 gram):</p>
<p class="p1">Kalori : 120&ndash;150 kkal</p>
<p class="p1">Protein : 3&ndash;5 gram</p>
<p class="p1">Lemak : 10&ndash;12 gram</p>
<p class="p1">Lemak jenuh: 4&ndash;6 gram</p>
...
<p class="p1">4. Siram salad dengan campuran minyak zaitun dan perasan lemon.</p>
<p class="p1">5. Taburkan biji chia di atasnya (opsional).</p>
<p class="p1">6. Sajikan segar.</p>
<p class="p1"><strong>Informasi Nilai Gizi (per porsi):</strong></p>
<p class="p1">&bull; Kalori: ~200 kkal</p>
<p class="p1">&bull; Protein: ~30 gram</p>
<p class="p1">&bull; Lemak: ~8 gram (sebagian besar lemak sehat dari minyak zaitun)</p>
<p class="p1">&bull; Karbohidrat: ~4 gram</p>
<p class="p1">&bull; Serat: ~2 gram</p>
<p class="p1">Penjelasan: Cocok untuk Diet Apa?</p>
<p class="p1">1. Diet Rendah Kalori: Resep ini rendah kalori sehingga cocok untuk Anda yang ingin menurunkan berat badan dengan defisit kalori. Protein tinggi dari ayam membantu mempertahankan massa otot saat diet.</p>
...
<p class="p1">1 butir telur</p>
<p class="p1">50 gr ayam tanpa kulit (cincang)</p>
<p class="p1">1 sdm kecap rendah sodium</p>
<p class="p1">2 siung bawang putih (cincang)</p>
<p class="p1">Sayuran (wortel, brokoli, atau paprika)</p>
<p class="p1"><strong>Cara Pembuatan:</strong></p>
<p class="p1">Tumis bawang putih hingga harum, masukkan ayam hingga matang.</p>
<p class="p1">Tambahkan sayuran, nasi shirataki, dan kecap rendah sodium.</p>
<p class="p1">Tambahkan telur dan aduk rata.</p>
<p class="p2">&nbsp;</p>
<p class="p1"><strong>Nilai Gizi (per porsi):</strong></p>
...
<p class="p1">- 5 siung bawang merah (iris tipis)&nbsp;</p>
<p class="p1">- 2 buah cabai merah keriting (iris tipis, opsional)&nbsp;</p>
<p class="p1">- 2 sdm cuka apel atau cuka putih rendah natrium&nbsp;</p>
<p class="p1">- 1 sdm air perasan lemon&nbsp;</p>
<p class="p1">- 1 sdt madu (opsional, sebagai pengganti gula)&nbsp;</p>
<p class="p1">- &frac12; sdt garam rendah natrium atau skip garam jika perlu&nbsp;</p>
<p class="p1">- 100 ml air matang hangat&nbsp;</p>
<p class="p1">- 1 ruas jahe (memarkan)&nbsp;</p>
<p class="p1">- 1 lembar daun jeruk (opsional, untuk aroma)&nbsp;</p>
<p class="p1"><strong>Cara Membuat:</strong></p>
<p class="p1">1. Blansir sayur</p>
<p class="p1"><span class="Apple-converted-space">&nbsp;&nbsp; </span>- Rebus wortel, buncis, dan mentimun dalam air mendidih selama 1 menit, lalu segera masukkan ke dalam air es agar tetap renyah. Tiriskan.&nbsp;</p>
<p class="p1">2. Membuat larutan rendaman:&nbsp;</p>
<p class="p1"><span class="Apple-converted-space">&nbsp;&nbsp; </span>- Campurkan air hangat, cuka, perasan lemon, madu, jahe, dan garam rendah natrium (jika digunakan). Aduk hingga semua bahan larut.&nbsp;</p>
<p class="p1">3. Merendam sayuran:</p>
<p class="p1"><span class="Apple-converted-space">&nbsp;&nbsp; </span>- Masukkan semua sayuran dan bawang merah ke dalam wadah bersih kedap udara.&nbsp;</p>
<p class="p1"><span class="Apple-converted-space">&nbsp;&nbsp; </span>- Tuangkan larutan rendaman hingga semua sayuran terendam.&nbsp;</p>
<p class="p1"><span class="Apple-converted-space">&nbsp;&nbsp; </span>- Tambahkan daun jeruk untuk aroma segar (opsional).&nbsp;</p>
<p class="p1">4. Proses fermentasi:<span class="Apple-converted-space">&nbsp; </span>- Simpan di lemari es selama minimal 4&ndash;6 jam agar bumbu meresap.&nbsp;</p>
<p class="p1">5. Penyajian:<span class="Apple-converted-space">&nbsp; </span>- Acar ini bisa langsung disantap sebagai pelengkap makanan.&nbsp;</p>
<p class="p1"><strong>Catatan</strong></p>
<p class="p1">- Hindari penggunaan garam biasa atau air garam (brine) yang tinggi natrium.&nbsp;</p>
<p class="p1">- Gunakan rempah-rempah seperti jahe, kunyit, atau daun jeruk untuk meningkatkan rasa tanpa perlu banyak garam.&nbsp;</p>
<p class="p1">- Konsumsi secukupnya, meskipun sudah dimodifikasi.&nbsp;</p>
<p class="p1">Dengan modifikasi ini, acar tetap lezat, segar, dan aman dikonsumsi penderita hipertensi.</p>
<p class="p1"><strong>Nilai gizi</strong></p>
<ul class="ul1">
<li class="li1">Kalori: 25&ndash;30 kkal</li>
<li class="li1">Karbohidrat: 5&ndash;6 gram</li>
<li class="li1">Protein: 0,8&ndash;1 gram</li>
<li class="li1">Lemak: 0,1&ndash;0,2 gram</li>
<li class="li1">Serat: 1,5&ndash;2 gram</li>
<li class="li1">Natrium: 10&ndash;30 mg (rendah, karena hanya menggunakan sedikit garam rendah natrium atau tanpa garam)</li>
<li class="li1">Kalium: 150&ndash;200 mg</li>
<li class="li1">Vitamin A: 300&ndash;400 IU (terutama dari wortel)</li>
